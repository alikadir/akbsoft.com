...
// Windows Media Player Object ¸¦ Ã¼Å©ÇÏ¿© ÇÁ·¹ÀÓ¿¡ ¼±¾ð (Event : onload)
function onloadInit() {
	if(opener) {
		isOpener = opener;
...
function playStateAction(NewState) {
	switch(NewState) {
		...
		case(1) : res = "Müzik Durduruldu! Çalmak &#304;çin Play Butonuna T&#305;klay&#305;n&#305;z."; break;
		...
		case(6) : res = "Hat Kuruluyor - Yeni &#350;ark&#305; Serverden Ça&#287;r&#305;l&#305;yor."; break;
		...
		case(10) : res = "M&uuml;zik Çalmak &#304;çin Play Butonuna T&#305;klay&#305;n&#305;z."; break;
...
function resetPlayer() {
	var cfm = confirm("MÜZÍK LÍSTESÍNÍ SIFIRLAMAKTAN EMÍNMÍSÍNÍZ?\BÜTÜN YAPMIS OLDUGUNUZ SEÇÍMLER SÍLÍNECEKTÍR.");
	if(cfm) {
		isSetObjEnv = false;
		setObjEnv();
...
// Play µÇ°í ÀÖ´Â Position Time À» Ç¥½Ã
var pbs = 1;
...
// Play µÇ°í ÀÖ´Â Media ÀÇ Bitrate ¸¦ Ç¥½Ã
function getBitrate() {
	if(wmp != null) {
...
// frameset ¿¡ ¼±¾ðµÈ Toggle Show/Hide (setToggleTab ÇÔ¼ö¸¦ È£Ãâ)
function toggleTab() {
	if(parent.rows != null) {
